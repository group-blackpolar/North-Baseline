import { ArrowUpRight, GitCompare, MapPin, Ship, Users } from 'lucide-react';
...
const QUICK_ACCESS = [
  {
    ...
    icon: Ship,
    title: 'Port Analysis',
    body: "Analyze container movements across Panama's main ports.",
  },
  {
    sub: 'year-comparison',
    icon: GitCompare,
    title: 'Year Comparison',
    body: 'Compare maritime import activity across multiple years.',
  },
  {
    sub: 'consignee-details',
    icon: Users,
    title: 'Consignee Details',
    body: 'Explore individual consignee activity and distribution.',
  },
  {
    sub: 'origin-port-detail',
    icon: MapPin,
    title: 'Origin Port Analysis',
    body: 'Analyze international origin countries and departure ports.',
  },
];
      ...
      <header className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-text-secondary">
            {t('shark.tagline') || 'Maritime Imports Intelligence'}
          </p>
        </div>
      </header>
      <section className="space-y-3">
        <h2 className="ui-label">{t('shark.quickAccess') || 'QUICK ACCESS'}</h2>
